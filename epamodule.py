...
if _plat=='Linux':
  ...
  try:
    ...
    _lib = ctypes.CDLL("epanet2x64.dll")
...
def ENepanet(nomeinp, nomerpt='', nomebin='', vfunc=None):
    ...
    if vfunc is not None:
        ...
        callback= None
    ierr= _lib.ENepanet(ctypes.c_char_p(nomeinp),
                        ctypes.c_char_p(nomerpt),
                        ctypes.c_char_p(nomebin),
                        callback)
...
def LoadInpFile(nomeinp, nomerpt, nomebin):
